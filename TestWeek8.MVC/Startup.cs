...
namespace TestWeek8.MVC
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IRepositoryUtente, RepositoryUtenteEF>();
            ...
            services.AddAuthorization(
                options =>
                {
                    options.AddPolicy("OwnerUser", policy => policy.RequireRole("Ristoratore"));
                    options.AddPolicy("ClientUser", policy => policy.RequireRole("Cliente"));
                }
            );
        }
